...
export default function BankDetailPage({ bank: bank, onBack }: BankDetailProps) {
    ...
    const statusStyle = getStatusStyle(bank.status);
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.headerRow}>
                <div>
                    <h1 style={styles.title}>Bank #{bank.id}</h1>
                </div>
                ...
                <div style={styles.actionsGroup}>
                    <span style={{
                        ...
                        {bank.status === "OPENED" ? "Active" : bank.status.toLowerCase()}
                    </span>
                </div>
            </div>
            ...
            <div style={styles.summaryCard}>
                ...
                <div style={styles.summaryGrid}>
                    <div>
                        ...
                        <span style={styles.summaryValue}>{bank.id || "N/A"}</span>
                    </div>
                    <div>
                        <span style={styles.summaryLabel}>Name</span>
                        <span style={styles.summaryValue}>{bank.name || "N/A"}</span>
                    </div>
                    <div>
                        <span style={styles.summaryLabel}>Created at</span>
                        <span style={styles.summaryValue}>{formatDateTime(bank.createdAt) || "N/A"}</span>
                    </div>
                </div>
